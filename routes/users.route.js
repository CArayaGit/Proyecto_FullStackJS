...
const { getUsers, getUser, createUser, loginUser, updateUser, deleteUser, getSalas, getEquipos, getNivel } = require("../controllers/user.controller");
...
router.get("/users/:id_user", requireAuth, getUser);
